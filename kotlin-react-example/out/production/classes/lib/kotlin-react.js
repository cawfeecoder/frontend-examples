(function (_, Kotlin, $module$react, $module$kotlin_extensions) {
  ...
  function RFragment$lambda(props) {
    return get_children(props);
  }
  var RFragment;
  ...
  Object.defineProperty(package$react, 'RFragment', {
    get: function () {
      return RFragment;
    }
  });
  ...
  var tmp$, tmp$_0;
  RFragment = (tmp$_0 = $module$react.Fragment) != null ? tmp$_0 : Kotlin.isType(tmp$ = RFragment$lambda, Object) ? tmp$ : throwCCE();
